...
<body style="margin: 160px; font-family: fantasy; background: linear-gradient(135deg, #325adf 0%, #e7530f 100%);text-align: center;">
<img style="width: 200px;margin-bottom: 95px;" src="<?=base_url()?>asset/call.png" alt="">
<br>
<a href="https://www.instagram.com/indtravel/">Silahkan Kunjungi Wonderful Indonesia</a>
</body>
</html>